				...
				<View style={styles.drawerContent}>
					<View style={styles.useInfoSection}>
						<View style={{ flexDirection: 'row', marginTop: 15 }}>
							<Avatar.Image source={require('../../../../Assets/Images/oval.png')} />
					...
					<Drawer.Section style={styles.drawerSection}>
						...
						<DrawerItem
							icon={() => (
								<View>
									<Image source={require('../../../../Assets/Images/accounts.png')} resizeMode="contain" />
								</View>
							)}
							label="Accounts"
							onPress={() => {
						...
						<DrawerItem
							icon={() => (
								<View>
									<Image source={require('../../../../Assets/Images/giving.png')} resizeMode="contain" />
								</View>
							)}
							label="Givings"
							onPress={() => {
						...
						<DrawerItem
							icon={() => (
								<View>
									<Image source={require('../../../../Assets/Images/payment.png')} resizeMode="contain" />
								</View>
							)}
							label="Payments"
							onPress={() => {
						...
						<DrawerItem
							icon={() => (
								<View>
									<Image source={require('../../../../Assets/Images/cards.png')} resizeMode="contain" />
								</View>
							)}
							label="Cards"
							onPress={() => {
